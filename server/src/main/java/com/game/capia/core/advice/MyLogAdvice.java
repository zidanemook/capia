package com.game.capia.core.advice;
...
public class MyLogAdvice {
    ...
    @Pointcut("@annotation(com.game.capia.core.annotation.MyLog)")
    public void myLog(){}

    @Pointcut("@annotation(com.game.capia.core.annotation.MyErrorLog)")
